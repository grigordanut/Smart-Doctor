...
public class PatientEditProfile extends AppCompatActivity {
    ...
    private void updatePatientDetails() {
        ...
        if (validateHospUpdatedData()) {
            ...
            Patients pat_Data = new Patients(pat_CardCodeUp, pat_UniqueCodeUp, pat_FirstNameUp, pat_LastNameUp, pat_EmailUp, patHospName, patHospitalKey, patDoctorName, patDoctorKey);
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (pat_Data != null) {
                        if (firebaseUser.getUid().equals(postSnapshot.getKey())) {
                            ...
                            patHospName = pat_Data.getPatHosp_Name();
                            patHospitalKey = pat_Data.getPatHosp_Key();
