...
public class Doctor {
    ...
    public Doctor(String docUnique_Code, String docFirst_Name, String docLast_Name, String docPhone_Number, String docEmail_Address, String docHosp_ID) {
    ...
    public String getDocHosp_ID() {
        return docHosp_ID;
    }

    public void setDocHosp_ID(String docHosp_ID) {
        this.docHosp_ID = docHosp_ID;
    }
